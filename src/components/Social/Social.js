...
const SocialLinks = {
  youtube: 'https://www.youtube.com/channel/UC_gNg-GxwrhNzfo0bELSPWA',
  instagram: 'https://www.instagram.com/adam.bosnjakovic/',
  twitter: 'https://twitter.com/adimension_io',
  github: 'https://github.com/theadameden',
  codepen: 'https://codepen.io/theadameden/',
  linkdin: 'https://www.linkedin.com/in/adimension/',
  email: 'mailto:adam@adimension.io',
  facebook: 'https://www.facebook.com/up.and.adam',
}
...
class Social extends React.Component {
  render() {
    return (
      <Wrapper>
        <ul className="soc socials">
          {/* <li>
          <a target="_blank" rel="noopener noreferrer"
            className="icon-1 8tracks"
            href="#"
            title="8tracks"
          ...
          {/* <li>
          <a target="_blank" rel="noopener noreferrer"
            className="icon-23 stackoverflow"
            href="#"
            title="StackOverflow"
            preserveAspectRatio="xMidYMid meet"
          >
