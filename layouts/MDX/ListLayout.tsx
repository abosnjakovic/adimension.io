    ...
    <>
      <div className="">
        <div className="space-y-2 rounded-lg pt-8 pb-3 md:space-y-5">
          <h1 className="font-mono text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-5xl md:leading-14">
            {title}
          </h1>
